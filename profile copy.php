		...
		<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
			...
			<div class="md:col-span-2 lg:col-span-1" >
				<div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
					...
					<div>
						<h5 class="text-3xl font-bold text-gray-700 text-center">My Information</h5>
						<span class="block text-center text-gray-500">Joined: <? echo "2022" ?> </span>
					</div>
					
					<form>
						<div class="relative z-0 w-full mb-6 group">
							<input type="text" name="floating_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="  " required="">
			...
			<div>
				<div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
					<h5 class="text-3xl font-bold text-gray-700 text-center">Current Account</h5>
					<h1 class="text-xl font-bold text-gray-800 text-center">@kwamekaku</h1>
					<!-- <div class="my-8">
						<h1 class="text-xl font-bold text-gray-800">64,5%</h1>
					...
					<table class="mt-6 -mb-2 w-full text-gray-600">
						<tbody>
							<tr>
								<td class="py-2 font-bold">Plan</td>
								<td class="text-gray-500">Free</td>
								<!-- <td>
							...
							<!-- <tr>
								<td class="py-2 font-bold">Admin</td>
								<td class="text-gray-500">@kwamewkaku</td>
								<td class="text-gray-500">@kojo</td>
								<td class="text-gray-500">@kojo</td>
								<td class="text-gray-500">@kojo</td>
							</tr> -->
						</tbody>
					...
					<div class="py-5">
						...
						<table class=" -mb-2 w-full text-gray-600">
							<tbody>
								<tr>
									<td class="py-2">@kwamekaku</td>
									<td class="text-gray-500">
										<div class="flex ">
											<span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Me</span>
											<span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Owner</span>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td class="text-gray-500">
										<div class="flex ">
											<span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">John Charlie</span>
											<span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Editor</span>
										</div>
									</td>
								</tr>
							</tbody>
					...
					<div>
						<p  class="text-sm">Upgrade this account to Linktree PRO to give other users access to manage it</p>
					</div>
					<div class="space-y-2 text-center">
						<button type="submit" class="text-black bg-white border-2 border-gray-200 hover:bg-main hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Links</button>
						<button type="submit" class="text-black bg-white border-2 border-gray-200 hover:bg-main hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Appearance</button>
						<button type="submit" class="text-black bg-white border-2 border-gray-200 hover:bg-main hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Settings</button>
						<!-- <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upgrade</button> -->
					</div>
					<div class="py-5">
						<button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Upgrade</button>
					</div>
